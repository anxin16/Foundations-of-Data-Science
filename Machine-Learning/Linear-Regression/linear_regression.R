...
# 1. summary of energy and metro columns, all rows
...
# 2. Fit our regression model
sat.mod1 <- lm(energy ~ metro, data=states.data)
# Summarize and print the results
summary(sat.mod1) # show regression coefficients table
# 3. `plot' the model
plot(sat.mod1, which = c(1, 2))

# summary of energy and metro + density columns, all rows
sts.dens.energy <- subset(states.data, select = c("density", "energy"))
summary(sts.dens.energy)
# correlation between energy and metro
cor(sts.dens.energy)
# scatter plot of energy vs metro
plot(sts.dens.energy)
# Fit our regression model
sat.mod2 <- lm(energy ~ metro + density, data=states.data)
# Summarize and print the results
summary(sat.mod2) # show regression coefficients table
# `plot' the model
plot(sat.mod2, which = c(1, 2))
anova(sat.mod1, sat.mod2)

# summary of energy and metro + density + area columns, all rows
sts.area.energy <- subset(states.data, select = c("area", "energy"))
summary(sts.area.energy)
# correlation between energy and metro
cor(sts.area.energy)
# scatter plot of energy vs metro
plot(sts.area.energy)
# Fit our regression model
sat.mod3 <- lm(energy ~ metro + density + area, data=states.data)
# Summarize and print the results
summary(sat.mod3) # show regression coefficients table
# `plot' the model
plot(sat.mod3, which = c(1, 2))
anova(sat.mod1, sat.mod2, sat.mod3)

# Fit our regression model
sat.mod4 <- lm(energy ~ metro + area, data=states.data)
# Summarize and print the results
summary(sat.mod4) # show regression coefficients table
# `plot' the model
plot(sat.mod4, which = c(1, 2))
anova(sat.mod1, sat.mod2, sat.mod3, sat.mod4)
...
# 1. Add the interaction to the model
energy.dens.by.area <- lm(energy ~ density*area, data=states.data) 
# Show the results
summary(energy.dens.by.area)
# show regression coefficients table
coef(summary(energy.dens.by.area))
